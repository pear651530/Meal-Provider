...
const translations = {
  en: {
    ...
    "餐點名稱 (必填)": "Meal Name (Mandatory Fields)",
    "餐點英文名稱 (非必填)": "Meal English Name (Optional Fields)",
    "價格 (必填)": "Price (Mandatory Fields)",
    "圖片連結 (必填)": "Image URL (Mandatory Fields)",
    "送出新增": "Submit",
