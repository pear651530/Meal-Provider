...
function MenuEditorPage(): JSX.Element {
  ...
  if (loading) return <p className="MenuEditor-loading">載入中...</p>;

  return (
    <div>
      <Navbar />
      <div className="MenuEditor-page-content">
        <h2 className="MenuEditor-page-title">📋 菜單調整頁面</h2>
        ...
        >
          <h3 className="MenuEditor-page-title">📌 今日餐點</h3>
        ...
        >
          <h3 className="MenuEditor-page-title">📂 非今日餐點</h3>
        ...
        {showAddForm && (
          <div ref={addFormRef} className="MenuEditor-add-form">
            ...
            />
            <button onClick={handleAddMeal}>📤 送出新增</button>
          </div>
        )}
      </div>
    </div>
